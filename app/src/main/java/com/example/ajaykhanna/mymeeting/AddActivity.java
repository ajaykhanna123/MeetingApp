...
import com.example.ajaykhanna.mymeeting.database.DBHelper;
            ...
            public void onClick(View view) {
                ...
                if(t.equals("")||du.equals("")||d.equals("")||time.equals("")){
                    ...
                    if(insert == true){
                        ...
                        Toast.makeText(AddActivity.this, "Time already exists, Please choose some other time", Toast.LENGTH_SHORT).show();
                    }
                }
